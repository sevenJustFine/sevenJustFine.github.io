---
title: rocket 延迟加载
date: 2022-10-21 15:11:42
tags:
---

html的head中加入script引入js
```javascript
    <script>
            ...
            _batchInjectResourceHints(e, t) {
                ...
                e.forEach((e => {
                        if (e.src) {
                            ...
                            e.getAttribute && "module" === e.getAttribute("data-rocket-type") && (i.crossOrigin = !0),
...
要延迟加载的js的type使用 rocketlazyloadscript
```javascript
